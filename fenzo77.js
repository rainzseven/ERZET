...
Saya *${namebot}*, Assisten *Erzet Official* Bot Ini Adalah Beta Multi-Device WhatsApp.
...
> Region : *Indonesia 🇲🇨*
> Hobyy : *Coding*
> Made in : *Bandung City*
> Nama Asli : *Rainz Seven [RZ]*
────────────
❏ *Info Server*
...
case 'hanzo': case 'prp': case 'inventori': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	{ urlButton: { displayText: `Group WhatsApp`, url : `Ga ada` } },
        	{ urlButton: { displayText: `Instagram`, url : `https://Instagram.com/akhyargod` } },
            { urlButton: { displayText: `☎️Contact Me`, url: `+62 82129893899` } },
            { quickReplyButton: { displayText: `🏧 leaderboard`, id: 'leaderboard'} }
        	]
        	mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© ErzetBotMD', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
        	}
        	break
...
case 'list': case 'menu': case 'help': case '?': {
                let kontol = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/rayveness30'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 82129893899'
                                }
                            },{
                                quickReplyButton: {
...
mans.send5ButImg(m.chat, listmn, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Erzet 𝘖𝘧𝘧𝘪𝘤𝘪𝘢𝘭`, global.thumb, kontol)
}
        	break
case 'grupbot':
case 'groupbot':
